...
<Route
  ...
  element={React.createElement(withLayoutAndProtection(ParentHome, { allowedTypes: ['parent'] }))}
/>
<Route
  exact
  path={`${process.env.PUBLIC_URL}/student/:studentId`}
  element={React.createElement(withLayoutAndProtection(StudentDetails, { allowedTypes: ['parent'] }))}
/>
