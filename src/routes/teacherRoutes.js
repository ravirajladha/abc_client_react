  ...
  <>
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(ClassSubjects, { allowedTypes: ["teacher"] })
      )}
    />
    <Route
      exact
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(ClassResults, { allowedTypes: ["teacher"] })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(AllClasses, { allowedTypes: ["teacher"] })
      )}
    />
    <Route
      exact
      ...
      element={React.createElement(
        withLayoutAndProtection(AllSubjects, { allowedTypes: ["teacher"] })
      )}
    />
    <Route
      exact
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(TeacherHome, { allowedTypes: ["teacher"] })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(Qnas, { allowedTypes: ["teacher"] })
      )}
    />
    <Route
      exact
      ...
      element={React.createElement(
        withLayoutAndProtection(AnswerQna, { allowedTypes: ["teacher"] })
      )}
    />
    <Route
      exact
      ...
      element={React.createElement(
        withLayoutAndProtection(Chats, { allowedTypes: ["teacher"] })
      )}
    />
    <Route
      exact
    ...
    <Route
      exact
      path={`${process.env.PUBLIC_URL}/teacher/settings`}
      element={React.createElement(
