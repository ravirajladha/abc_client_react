  ...
  <>
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(Home, { allowedTypes: ["school_student"] })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(Subjects, { allowedTypes: ["school_student"] })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(SubjectResults, {
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(Qna, { allowedTypes: ["school_student"] })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(Forums, { allowedTypes: ["school_student"] })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(ViewQna, { allowedTypes: ["school_student"] })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(ViewForum, { allowedTypes: ["school_student"] })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(AnswerForum, {
          allowedTypes: ["school_student"],
        })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(SubjectStream, {
          allowedTypes: ["school_student"],
        })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(TakeAssessments, {
          allowedTypes: ["school_student"],
        })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(ViewAssessmentScore, {
          allowedTypes: ["school_student"],
        })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(TakeTest, { allowedTypes: ["school_student"] })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(ViewTestScore, {
          allowedTypes: ["school_student"],
        })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(StartProject, {
          allowedTypes: ["school_student"],
        })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(Elab, { allowedTypes: ["school_student"] })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(VideoFeatures, {
          allowedTypes: ["school_student"],
        })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(Markers, { allowedTypes: ["school_student"] })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(MarkerSingle, {
          allowedTypes: ["school_student"],
        })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(VideoWithWaterMark, {
          allowedTypes: ["school_student"],
        })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(TestDetails, {
          allowedTypes: ["school_student"],
        })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(StudentSettings, {
          allowedTypes: ["school_student"],
        })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(StudentProfile, {
          allowedTypes: ["school_student"],
        })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(StudentProfile1, {
          allowedTypes: ["school_student"],
        })
      )}
    />
    ...
    <Route
      ...
      element={React.createElement(
        withLayoutAndProtection(Internship, {
          allowedTypes: ["school_student"],
        })
      )}
    />
