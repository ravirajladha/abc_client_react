...
function CreateAssessments() {
    ...
    const createAssessment = (e) => {
        ...
        navigate("/assessments/add-question-to-assessment", {
            state: { subjectId: selectedSubject, assessmentId: resp.assessment.id },
          });
                                            ...
                                            <div className="row mb-6">
                                                ...
                                                <div className="col-lg-12">
                                                    <div className="form-group float-right">
                                                        ...
                                                        <button
                                                            type="submit"
                                                            className="mt-5 btn bg-current text-center text-white font-xsss fw-600 p-3 w175 rounded-lg d-inline-block border-0"  disabled={isSubmitting}
                                                        >
                                                            Next
                                                        </button>
                                                    </div>
