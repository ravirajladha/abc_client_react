...
function Image_4_3({ element }) {
    ...
    return (
        <>
            <div className="img-preview-4_3">
                <img src="/assets_ebook/images/4.3.png" alt="preview" className="introduction-img" />
