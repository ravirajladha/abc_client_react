...
function Image_8_1({ element }) {
    ...
    return (
        <>
            <div className="img-preview-8_1">
                <img src={`/assets_ebook/images/8.1.png`} alt="preview" className="introduction-img" />

                <div className="box0">
                    <p className="p0">{element.image_heading}</p>
                </div>
                <div class="box0_1">
                    <p class="p0_1">{element.image_heading_2}</p>
                </div>
