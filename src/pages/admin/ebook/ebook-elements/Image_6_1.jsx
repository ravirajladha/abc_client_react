...
function Image_6_1({element}) {
    ...
    return (
        <>
            <div className="img-preview-6_1">
                <img src={`/assets_ebook/images/6.1.png`} alt="preview" className="introduction-img" />
