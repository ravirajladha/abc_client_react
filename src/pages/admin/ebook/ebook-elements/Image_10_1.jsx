...
function Image_10_1({element}) {
    ...
    return (
        <>
        <div className="img-preview-10_1">
            <img src={`/assets_ebook/images/10.1.png`} alt="preview" className="introduction-img" />
