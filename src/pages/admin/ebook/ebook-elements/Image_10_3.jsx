...
function Image_10_3({element}) {
    ...
    return (
        <>
        <div className="img-preview-10_3">
            <img src={`/assets_ebook/images/10.3.png`} alt="preview" className="introduction-img" />
