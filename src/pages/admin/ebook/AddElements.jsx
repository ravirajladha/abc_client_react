                ...
                if (selectedValue === 'image_2_3') {
                    setAdditionalField(
                        <>
                            ...
                            <div className="col-lg-4 mb-3">
                                <a onClick={() => window.open('/assets_ebook/images/2.3.png', '_blank', 'width=800,height=600')}>
                    ...
                    setAdditionalField(
                        <>
                            ...
                            <div className="col-lg-4 mb-3">
                                <a onClick={() => window.open(imageLink, '_blank', 'width=800,height=600')}>
                ...
                if (selectedValue === 'image_3_1') {
                    setAdditionalField(
                        <>
                            ...
                            <div className="col-lg-4 mb-3">
                                <a onClick={() => window.open('/assets_ebook/images/3.1.png', '_blank', 'width=800,height=600')}>
                    ...
                    setAdditionalField(
                        <>
                            ...
                            <div className="col-lg-4 mb-3">
                                <a onClick={() => window.open('/assets_ebook/images/3.2.png', '_blank', 'width=800,height=600')}>
                                    <img src="/assets_ebook/images/3.1.png" alt="photo1" style={{ height: '100px', maxWidth: '100%' }} />
                                </a>
                            </div>
                            <div className="col-lg-4 mb-3"></div>
                ...
                if (selectedValue === 'image_4_1') {
                    setAdditionalField(
                        <>
                            ...
                            <div className="col-lg-4 mb-3">
                                <a onClick={() => window.open('/assets_ebook/images/4.1.png', '_blank', 'width=800,height=600')}>
                    ...
                    setAdditionalField(
                        <>
                            ...
                            <div className="col-lg-4 mb-3">
                                <a onClick={() => window.open('/assets_ebook/images/4.2.png', '_blank', 'width=800,height=600')}>
                    ...
                    setAdditionalField(
                        <>
                            ...
                            <div className="col-lg-4 mb-3">
                                <a onClick={() => window.open('/assets_ebook/images/4.3.png', '_blank', 'width=800,height=600')}>
                ...
                if (selectedValue === 'image_5_1') {
                    setAdditionalField(
                        <>
                            ...
                            <div className="col-lg-4 mb-3">
                                <div className="form-group">
                                    <label className="mont-font fw-600 font-xsss">Image Type</label>
                                    <select className="form-control" name="image_type" id="image_type" onChange={handleImage5TypeChange}>
                                        <option value="" selected disabled readOnly>--select--</option>
                            ...
                            <div className="col-lg-4 mb-3">
                                <a onClick={() => window.open('/assets_ebook/images/5.1.png', '_blank', 'width=800,height=600')}>
                                    <img src="/assets_ebook/images/5.1.png" alt="photo1" style={{ height: '100px', maxWidth: '100%' }} />
                                </a>
                            </div>
                            <div className="col-lg-4 mb-3"></div>
                            <div className="col-lg-4 mb-3">
                            ...
                            <div className="col-lg-4 mb-3">
                                <div className="form-group">
                                    ...
                                    <input type="text" className="form-control" placeholder="Enter Text" name="image_text_5"
                            ...
                            <div className="col-lg-8 mb-3">
                                <div className="form-group">
                                    <label className="mont-font fw-600 font-xsss">Description</label>
                                    <textarea name="image_desc_5" className="form-control mb-0 p-3 h100 bg-greylight lh-16" rows="5" placeholder="Enter Description..." spellCheck="false"
                                        value={inputFields.image_desc_5}
                                        onChange={(e) => handleInputChange(e, 'image_desc_5')}></textarea>
                                </div>
                            </div>
                        </>
                    );
                    ...
                    setAdditionalField(
                        <>
                            ...
                            <div className="col-lg-4 mb-3">
                                <a onClick={() => window.open('/assets_ebook/images/5.2.png', '_blank', 'width=800,height=600')}>
                                    <img src="/assets_ebook/images/5.2.png" alt="photo1" style={{ height: '100px', maxWidth: '100%' }} />
                                </a>
                            </div>
                            <div className="col-lg-4 mb-3"></div>
                            <div className="col-lg-4 mb-3">
                            ...
                            <div className="col-lg-4 mb-3">
                                <div className="form-group">
                                    <label className="mont-font fw-600 font-xsss">Sub Heading 2</label>
                                    <input type="text" className="form-control" placeholder="Enter Heading" name="image_subheading_2"
                ...
                if (selectedValue === 'image_6_1') {
                    setAdditionalField(
                        <>
                            ...
                            <div className="col-lg-4 mb-3">
                                <div className="form-group">
                                    <label className="mont-font fw-600 font-xsss">Image Type</label>
                                    <select className="form-control" name="image_type" id="image_type" onChange={handleImage6TypeChange}>
                                        <option value="" selected disabled readOnly>--select--</option>
                            ...
                            <div className="col-lg-4 mb-3">
                                <a onClick={() => window.open('/assets_ebook/images/6.1.png', '_blank', 'width=800,height=600')}>
                                    <img src="/assets_ebook/images/6.1.png" alt="photo1" style={{ height: '100px', maxWidth: '100%' }} />
                                </a>
                            </div>
                            <div className="col-lg-4 mb-3"></div>
                            <div className="col-lg-4 mb-3">
                            ...
                            <div className="col-lg-4 mb-3">
                                <div className="form-group">
                                    ...
                                    <input type="text" className="form-control" placeholder="Enter Heading" name="image_heading_2"
                            ...
                            <div className="col-lg-4 mb-3">
                                <div className="form-group">
                                    ...
                                    <input type="text" className="form-control" placeholder="Enter Text" name="image_text_6"
                            ...
                            <div className="col-lg-8 mb-3">
                                <div className="form-group">
                                    <label className="mont-font fw-600 font-xsss">Description</label>
                                    <textarea name="image_desc_6" className="form-control mb-0 p-3 h100 bg-greylight lh-16" rows="5" placeholder="Enter Description..." spellCheck="false"
                                        value={inputFields.image_desc_6}
                                        onChange={(e) => handleInputChange(e, 'image_desc_6')}></textarea>
                                </div>
                            </div>
                        </>
                    );
                    ...
                    setAdditionalField(
                        <>
                            ...
                            <div className="col-lg-4 mb-3">
                                <a onClick={() => window.open('/assets_ebook/images/6.2.png', '_blank', 'width=800,height=600')}>
                                    <img src="/assets_ebook/images/6.2.png" alt="photo1" style={{ height: '100px', maxWidth: '100%' }} />
                                </a>
                            </div>
                            <div className="col-lg-4 mb-3"></div>
                            <div className="col-lg-4 mb-3">
                    ...
                    setAdditionalField(
                        <>
                            ...
                            <div className="col-lg-4 mb-3">
                                <div className="form-group">
                                    <label className="mont-font fw-600 font-xsss">Image Type</label>
                                    <select className="form-control" name="image_type" id="image_type" onChange={handleImage7TypeChange}>
                                        <option value="" selected disabled readOnly>--select--</option>
                            ...
                            <div className="col-lg-4 mb-3">
                                <a onClick={() => window.open('/assets_ebook/images/7.1.png', '_blank', 'width=800,height=600')}>
                                    <img src="/assets_ebook/images/7.1.png" alt="photo1" style={{ height: '100px', maxWidth: '100%' }} />
                                </a>
                            </div>
                            <div className="col-lg-4 mb-3"></div>
                            <div className="col-lg-4 mb-3">
                            ...
                            <div className="col-lg-4 mb-3">
                                <div className="form-group">
                                    ...
                                    <input type="text" className="form-control" placeholder="Enter Text" name="image_text_7"
                            ...
                            <div className="col-lg-8 mb-3">
                                <div className="form-group">
                                    <label className="mont-font fw-600 font-xsss">Description</label>
                                    <textarea name="image_desc_7" className="form-control mb-0 p-3 h100 bg-greylight lh-16" rows="5" placeholder="Enter Description..." spellCheck="false"
                                        value={inputFields.image_desc_7}
                                        onChange={(e) => handleInputChange(e, 'image_desc_7')}></textarea>
                                </div>
                            </div>
                        </>
                    );
                ...
                if (selectedValue === 'image_8_1') {
                    setAdditionalField(
                        <>
                            ...
                            <div className="col-lg-4 mb-3">
                                <div className="form-group">
                                    <label className="mont-font fw-600 font-xsss">Image Type</label>
                                    <select className="form-control" name="image_type" id="image_type" onChange={handleImage8TypeChange}>
                                        <option value="" selected disabled readOnly>--select--</option>
                            ...
                            <div className="col-lg-4 mb-3">
                                <a onClick={() => window.open('/assets_ebook/images/8.1.png', '_blank', 'width=800,height=600')}>
                                    <img src="/assets_ebook/images/8.1.png" alt="photo1" style={{ height: '100px', maxWidth: '100%' }} />
                                </a>
                            </div>
                            <div className="col-lg-4 mb-3"></div>
                            <div className="col-lg-4 mb-3">
                            ...
                            <div className="col-lg-4 mb-3">
                                <div className="form-group">
                                    ...
                                    <input type="text" className="form-control" placeholder="Enter Text" name="image_text_8"
                            ...
                            <div className="col-lg-8 mb-3">
                                <div className="form-group">
                                    <label className="mont-font fw-600 font-xsss">Description</label>
                                    <textarea name="image_desc_8" className="form-control mb-0 p-3 h100 bg-greylight lh-16" rows="5" placeholder="Enter Description..." spellCheck="false"
                                        value={inputFields.image_desc_8}
                                        onChange={(e) => handleInputChange(e, 'image_desc_8')}></textarea>
                                </div>
                            </div>
                        </>
                    );
                    ...
                    setAdditionalField(
                        <>
                            ...
                            <div className="col-lg-4 mb-3">
                                <a onClick={() => window.open('/assets_ebook/images/8.2.png', '_blank', 'width=800,height=600')}>
                                    <img src="/assets_ebook/images/8.2.png" alt="photo1" style={{ height: '100px', maxWidth: '100%' }} />
                                </a>
                            </div>
                            <div className="col-lg-4 mb-3"></div>
                            <div className="col-lg-4 mb-3">
                ...
                setAdditionalField(
                    <>
                        ...
                        <div className="col-lg-4 mb-3">
                            <div className="form-group">
                                <label className="mont-font fw-600 font-xsss">Image Type</label>
                                <select className="form-control" name="image_type" id="image_type" onChange={handleImage10TypeChange}>
                                    <option value="" selected disabled readOnly>--select--</option>
                        ...
                        <div className="col-lg-4 mb-3">
                            <a onClick={() => window.open(imageUrl, '_blank', 'width=800,height=600')}>
                                <img src={imageUrl} alt="photo1" style={{ height: '100px', maxWidth: '100%' }} />
                            </a>
                        </div>
                        <div className="col-lg-4 mb-3"></div>
                        <div className="col-lg-4 mb-3">
                        ...
                        <div className="col-lg-4 mb-3">
                            <div className="form-group">
                                ...
                                <input type="text" className="form-control" placeholder="Enter Text" name="image_text_9"
                        ...
                        <div className="col-lg-8 mb-3">
                            <div className="form-group">
                                <label className="mont-font fw-600 font-xsss">Description</label>
                                <textarea name="image_desc_9" className="form-control mb-0 p-3 h100 bg-greylight lh-16" rows="5" placeholder="Enter Description..." spellCheck="false"
                                    value={inputFields.image_desc_9}
                                    onChange={(e) => handleInputChange(e, 'image_desc_9')}></textarea>
                            </div>
                        </div>
                        <div className="col-lg-4 mb-3">
                            <div className="form-group">
                                <label className="mont-font fw-600 font-xsss">Text-10</label>
                                <input type="text" className="form-control" placeholder="Enter Text" name="image_text_10"
                        ...
                        <div className="col-lg-8 mb-3">
                            <div className="form-group">
                                <label className="mont-font fw-600 font-xsss">Description</label>
                                <textarea name="image_desc_10" className="form-control mb-0 p-3 h100 bg-greylight lh-16" rows="5" placeholder="Enter Description..." spellCheck="false"
                                    value={inputFields.image_desc_10}
                                    onChange={(e) => handleInputChange(e, 'image_desc_10')}></textarea>
                            </div>
                        </div>
                    </>
                );
                    ...
                    <>
                        <div className="col-lg-4 mb-3">
                            <div className="form-group">
                                ...
                                <select className="form-control" name="list_type" id="list_type"
                        ...
                        <div className="col-lg-4 mb-3">
                            <div className="form-group">
                                <label className="mont-font fw-600 font-xsss">Heading</label>
                                <input type="text" className="form-control" placeholder="Enter Heading" name="list_heading" 
                                ...
                                <div className="col-lg-6 mb-3">
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control" placeholder="Enter Points"
                                            onChange={(e) => handleInputArrayChange(e, 'list_points', index)} />
                                    </div>
                                </div>
                            </div>
                ...
                <>
                    <div className="col-lg-4 mb-3">
                        <div className="form-group">
                            ...
                            <input type="file" className="form-control" name="gif_file" onChange={(e) => handleImageChange(e, 'gif_file')} />
                        </div>
                    </div>
            ...
            const handleCountChange = (event) => {
                ...
                setAdditionalField(
                    <>
                        <div className="col-lg-6 mb-3">
                            <div className="form-group">
                                <label className="mont-font fw-600 font-xsss">No of Examples</label>
                                <input
                                    type="text"
                                    className="form-control"
                                    id="example_count"
                        ...
                        {inputArray.map((index) => (
                            <div className="row" key={index}>
                                <div className="col-lg-4 mb-3">
                                    <div className="form-group">
                                        <label className="mont-font fw-600 font-xsss">Text for Example button(optional)</label>
                                        <input type="text" className="form-control" placeholder="Enter data" name={`example_text_${index}`}
                                            onChange={(e) => handleInputArrayChange(e, 'example_text', index)} />
                                    </div>
                                </div>
                                <div className="col-lg-4 mb-3">
                                    <div className="form-group">
                                        <label className="mont-font fw-600 font-xsss">Description for Example button</label>
                                        <textarea
                                            className="form-control mb-0 p-3 h100 bg-greylight lh-16"
                                            rows="5"
                                            placeholder="Enter Description..."
                                            spellCheck="false"
                                            onChange={(e) => handleInputArrayChange(e, 'example_description', index)}
                                        />
                                    </div>
                                </div>
                                <div className="col-lg-4 mb-3">
                                    <div className="form-group">
                                        <label className="mont-font fw-600 font-xsss">Description for practice</label>
                                        <textarea
                                            className="form-control mb-0 p-3 h100 bg-greylight lh-16"
                                            rows="5"
                                            placeholder="Enter Description..."
                                            spellCheck="false"
                                            onChange={(e) => handleInputArrayChange(e, 'practice_description', index)}
                                        />
                                    </div>
                                </div>
                            </div>
                        ...
                        {inputArray.map((index) => (
                            <div className="row" key={index}>
                                <div className="col-lg-6 mb-3">
                                    <div className="form-group">
                                        <label className="mont-font fw-600 font-xsss">GIF file</label>
                                        <input type="file" className="form-control" placeholder="Enter data"
                    ...
                    <>
                        ...
                        {inputArray.map((index) => (
                            <div className="row" key={index}>
                                <div className="col-lg-4 mb-3">
                                    <div className="form-group">
                                        <label className="mont-font fw-600 font-xsss">Text on the image</label>
                                        <input type="text" className="form-control" placeholder="Enter data"
                                            onChange={(e) => handleInputArrayChange(e, 'example_image_text', index)} />
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-4 mb-3">
                                    <div className="form-group">
                                        <label className="mont-font fw-600 font-xsss">Description for programming example</label>
                                        <textarea
                                            className="form-control mb-0 p-3 h100 bg-greylight lh-16"
                                            rows="5"
                                            placeholder="Enter Description..."
            ...
            const handleCountChange = (event) => {
                ...
                setAdditionalField(
                    <>
                        <div className="col-lg-6 mb-3">
                            <div className="form-group">
                                <label className="mont-font fw-600 font-xsss">No of Buttons</label>
                                <input
                                    type="text"
                                    className="form-control"
                                    id="example_count"
                            ...
                            <div className="row" key={index}>
                                <div className="col-lg-4 mb-3">
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control" placeholder="Enter data"
                                            onChange={(e) => handleInputArrayChange(e, 'button_text', index)} />
                                    </div>
                                </div>
            ...
            const handleCountChange = (event) => {
                ...
                setAdditionalField(
                    <>
                        <div className="col-lg-6 mb-3">
                            <div className="form-group">
                                <label className="mont-font fw-600 font-xsss">No of Text Box</label>
                                <input
                                    type="text"
                                    className="form-control"
                                    id="example_count"
