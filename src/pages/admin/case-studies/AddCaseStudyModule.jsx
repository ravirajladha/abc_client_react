  ...
  async function postData(e) {
    ...
    try {
      const response = await fetch(
        baseUrl + "api/case-studies/" + caseStudyId + "/store-module",
        {
          method: "POST",
          body: formData,
        }
      ...
      navigate('/case-studies/case-study-modules/' + caseStudyId );
...
export default AddCaseStudyModule;
