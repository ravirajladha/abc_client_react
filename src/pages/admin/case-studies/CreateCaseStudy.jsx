...
function CreateCaseStudy() {
  ...
  const createCaseStudy = (e) => {
    ...
    fetch(baseUrl + "api/create-case-study", {
      method: "POST",
      body: formData,
    })
      .then((res) => res.json())
      ...
      .catch((err) => {
        toast.error("Could not submit Case Study: " + err.message);
      })
      .finally(() => {
        setShowLoader(false);
          ...
          <div className="row">
            ...
            <div className="card w-100 border-0 bg-white shadow-lg p-0 mb-4">
              ...
              <div className="card-body p-lg-5 p-4 w-100 border-0 ">
                <form encType="multipart/form-data" onSubmit={createCaseStudy}>
