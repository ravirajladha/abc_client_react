...
function AddQuestionsToAssessment() {
    ...
    const getQuestions = (e) => {
        let result = fetch(baseUrl + 'api/get_assessment_questions_by_subject/' + subjectId).then(function (result) {
    ...
    const addQuestionsToAssessment = (e) => {
        ...
        fetch(baseUrl + "api/add_question_to_assessment", {
            method: 'POST',
            body: formData
        }).then((res) => {
            return res.json();
...
export default AddQuestionsToAssessment
