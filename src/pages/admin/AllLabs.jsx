...
console.log(baseUrl);
          ...
          <div className="middle-sidebar-bottom theme-dark-bg">
            <div className="middle-sidebar-left">
              ...
              <div className="col-lg-12 pt-0 mb-3 d-flex justify-content-between">
                                    <div>
                                        <h2 className="fw-400 font-lg d-block">All <b> E-Labs</b> </h2>
                                    </div>
                                    <div className="float-right">
                                    <Link to={'/create_lab_new'} className="p-2  d-inline-block text-white fw-700 lh-30 rounded-lg  text-center font-xsssss ls-3 bg-current mx-1">ADD E-LAB</Link>
  ...
  {labs.map((lab, index) => (
    <tr key={index}>
      ...
      <td>{lab.name}</td>
      <td>{lab.class_name}</td> {/* Directly using the chapter_name property */}
      <td>{lab.chapter_name}</td> {/* Directly using the chapter_name property */}
      <td>{lab.subject_name}</td> {/* Directly using the chapter_name property */}
      <td>{lab.video_name}</td> {/* Directly using the chapter_name property */}
