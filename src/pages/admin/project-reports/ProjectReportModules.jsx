                      ...
                      projectReportModules.map((module, index) => (
                        ...
                        >
                          ...
                          >
                            ...
                            <Link
                              to={"/project-reports/add-sections/" + module.id}
                          ...
                          <Accordion.Body>
                            {module.project_report_sections ? (
                              module.project_report_sections.map((section, i) => (
                                <div key={i}>
                                  <div className="d-flex align-items-center justify-content-between">
                                    ...
                                    <Link
                                      to={"/project-reports/add-elements/" + section.id}
