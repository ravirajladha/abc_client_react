...
function ProjectReports() {
  ...
  function getProjectReports() {
    ...
    let result = fetch(baseUrl + "api/get-project-reports")
      ...
      .then(function (jsonbody) {
        setProjectReports(jsonbody.projectReports);
      })
            ...
            <div className="col-lg-12 pt-0 mb-3 d-flex justify-content-between">
              <div>
                <h2 className="fw-400 font-lg d-block">
                  All <b> Project Report</b>
                </h2>
              </div>
              <div className="float-right">
                <Link
                  to={"/project-reports/create-project-report"}
                ...
                // <div className="col-lg-12 mb-3">
                  <div className="col-xl-4 col-lg-6 col-md-6" key={index}>
                    <div className="card mb-4 d-block w-100 shadow-xss rounded-lg p-xxl-5 p-4 border-0 text-center">
                      ...
                      <h4 className="fw-700 font-xs mt-4">{projectReport.title}</h4>

                      <div className="text-center">
                        <Link
                          to={"/project-reports/preview_project-report-admin/" + projectReport.id}
                          className="p-2 mt-4 d-inline-block text-white fw-700 lh-30 rounded-lg w100 text-center font-xsssss ls-3 bg-current mx-1"
                        >
                          VIEW
                        </Link>
                        <Link
                          to={"/project-reports/project-report-modules/" + projectReport.id}
                          className="p-2 mt-4 d-inline-block text-white fw-700 lh-30 rounded-lg w100 text-center font-xsssss ls-3 bg-current mx-1"
                        >
                          CONTENT
                        </Link>
